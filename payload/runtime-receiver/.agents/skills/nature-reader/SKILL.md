...
Read `references/runtime-boundary.md` before using this Skill. The installed profile was accepted offline with synthetic or user-supplied inputs; external retrieval and unapproved writes remain outside that acceptance.
